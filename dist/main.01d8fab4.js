...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/gine/dist/gine/config.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Config = (function () {
    function Config(canvas, args) {
        this.canvas = canvas;
        this.args = args;
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
var isArray = /*@__PURE__*/exports.isArray = function () {
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
var rxSubscriber = /*@__PURE__*/exports.rxSubscriber = function () {
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
var observable = /*@__PURE__*/exports.observable = function () {
...
var connectableObservableDescriptor = /*@__PURE__*/exports.connectableObservableDescriptor = function () {
...
var Canvas = (function () {
    function Canvas(canvas) {
        ...
        this.canvasElm.width = core_1.Gine.CONFIG.width;
        this.canvasElm.height = core_1.Gine.CONFIG.height;
        this.width = core_1.Gine.CONFIG.width;
        this.height = core_1.Gine.CONFIG.height;
        if (core_1.Gine.CONFIG.usesTiles) {
            this.tilesX = Math.round(this.width / core_1.Gine.CONFIG.tileSize);
            this.tilesY = Math.round(this.height / core_1.Gine.CONFIG.tileSize);
        }
        this.resize();
    }
    Canvas.prototype.resize = function () {
        ...
        this.scale = Math.min(width / core_1.Gine.CONFIG.width, height / core_1.Gine.CONFIG.height);
        this.canvasElm.height = height;
        this.canvasElm.width = width;
        if (core_1.Gine && core_1.Gine.handle && core_1.Gine.handle.scale) {
            core_1.Gine.handle.scale(this.scale);
        }
        if (core_1.Gine.CONFIG.usesTiles) {
            this.tilesX = Math.round(this.width / core_1.Gine.CONFIG.tileSize);
            this.tilesY = Math.round(this.height / core_1.Gine.CONFIG.tileSize);
...
},{"./core":"../node_modules/gine/dist/gine/core.js"}],"../node_modules/gine/dist/gine/handle.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = require("./core");
var Handle = (function () {
    function Handle(canvas) {
        this.canvas = canvas;
        this.handle = this.canvas.canvasElm.getContext('2d');
        this.scale(this.canvas.scale);
    }
    Handle.prototype.clear = function () {
        this.handle.clearRect(-1, -1, core_1.Gine.CONFIG.width + 1, core_1.Gine.CONFIG.height + 1);
    };
    ...
    Handle.prototype.draw = function (image, x, y) {
        if (x < core_1.Gine.CONFIG.viewport.maxX &&
            x > core_1.Gine.CONFIG.viewport.minX &&
            y < core_1.Gine.CONFIG.viewport.maxY &&
            y > core_1.Gine.CONFIG.viewport.minY) {
            this.handle.drawImage(image.image, x, y);
        }
    };
    Handle.prototype.drawSprite = function (image, x, y, index) {
        if (index) {
        ...
        this.handle.drawImage(image.image, image.sourceX, image.sourceY, image.sizeX, image.sizeY, x, y, image.sizeX, image.sizeY);
    };
...
},{"./core":"../node_modules/gine/dist/gine/core.js"}],"../node_modules/gine/dist/gine/image.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/gine/dist/gine/store.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Store = (function () {
    ...
    Store.prototype.store = function (key, val) {
        this.database[key] = val;
    };
    Store.prototype.image = function (key, src, options) {
        var img = new image_1.ImageAsset(key, src, options);
        this.store(key, img);
    };
    Store.prototype.sprite = function (key, src, options) {
        var img = new image_1.SpriteAsset(key, src, options);
        this.store(key, img);
    };
    Store.prototype.get = function (key) {
        return this.database[key];
    };
    Store.prototype.getImage = function (key) {
        return this.get(key);
    };
    Store.prototype.getSprite = function (key) {
        return this.get(key);
    };
    Store.prototype.select = function (key, val) {
        return this.database.filter(function (obj) {
            return obj[key] === val;
        });
    };
    return Store;
...
},{"./image":"../node_modules/gine/dist/gine/image.js"}],"../node_modules/gine/dist/gine/text.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Text = (function () {
...
},{}],"../node_modules/gine/dist/gine/keyboard.keycodes.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KEYCODES = {
    BACKSPACE: 8,
...
//# sourceMappingURL=keyboard.keycodes.js.map
},{}],"../node_modules/gine/dist/gine/keyboard.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
var keyboard_keycodes_1 = require("./keyboard.keycodes");
var Keyboard = (function () {
    function Keyboard() {
        var _this = this;
        this.pressed = [];
        var keydown = rxjs_1.fromEvent(document, 'keydown').pipe(operators_1.filter(function (ev) {
            return !_this.pressed[ev.keyCode];
        }), operators_1.map(function (ev) {
            _this.pressed[ev.keyCode] = true;
            return ev;
        }));
        var keyup = rxjs_1.fromEvent(document, 'keyup').pipe(operators_1.map(function (ev) {
            _this.pressed[ev.keyCode] = false;
            return ev;
        }));
        this.key$ = rxjs_1.merge(keyup, keydown).pipe(operators_1.map(function (ev) {
            return { key: ev.key, type: ev.type };
        }));
    }
    Keyboard.prototype.allPressed = function () {
        return this.pressed;
    };
    Keyboard.prototype.isPressed = function (keycode) {
        return this.pressed[keycode];
    };
    Keyboard.KEYCODES = keyboard_keycodes_1.KEYCODES;
    return Keyboard;
}());
exports.Keyboard = Keyboard;
//# sourceMappingURL=keyboard.js.map
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./keyboard.keycodes":"../node_modules/gine/dist/gine/keyboard.keycodes.js"}],"../node_modules/gine/dist/gine/mouse.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
...
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./core":"../node_modules/gine/dist/gine/core.js"}],"../node_modules/gine/dist/gine/core.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
...
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./canvas":"../node_modules/gine/dist/gine/canvas.js","./handle":"../node_modules/gine/dist/gine/handle.js","./store":"../node_modules/gine/dist/gine/store.js","./text":"../node_modules/gine/dist/gine/text.js","./keyboard":"../node_modules/gine/dist/gine/keyboard.js","./mouse":"../node_modules/gine/dist/gine/mouse.js"}],"../node_modules/gine/dist/gine/camera.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Camera = (function () {
    function Camera() {
...
},{}],"../node_modules/gine/dist/gine/tile.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Tile = (function () {
    function Tile() {
...
},{}],"../node_modules/gine/dist/gine/scene.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = require("./core");
var Scene = (function () {
    ...
    Scene.prototype.destroy = function () {
        core_1.Gine.sendEvent(Scene.DESTROY_CURRENT_SCENE);
    };
    Scene.DESTROY_CURRENT_SCENE = 'DESTROY_CURRENT_SCENE';
    return Scene;
}());
exports.Scene = Scene;
exports.EMPTY_SCENE = new Scene();
//# sourceMappingURL=scene.js.map
},{"./core":"../node_modules/gine/dist/gine/core.js"}],"../node_modules/gine/dist/gine/math/Math2D.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = require("../core");
var Math2D = (function () {
    ...
    Math2D.rotate = function (image, x, y, degrees) {
        if (degrees === void 0) { degrees = 0; }
        var radians = (degrees * Math.PI) / 180;
        core_1.Gine.handle.handle.save();
        core_1.Gine.handle.handle.translate(x, y);
        core_1.Gine.handle.handle.rotate(radians);
        core_1.Gine.handle.handle.drawImage(image.image, 0 - image.width / 2, 0 - image.height / 2);
        core_1.Gine.handle.handle.restore();
    };
    Math2D.degreesToRadians = function (degrees) {
        return degrees * (Math.PI / 180);
    };
    Math2D.degreesToXY = function (degrees) {
        var radians = this.degreesToRadians(degrees - 90);
        return {
...
},{"../core":"../node_modules/gine/dist/gine/core.js"}],"../node_modules/gine/dist/gine/math/index.js":[function(require,module,exports) {
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
...
},{"./Math2D":"../node_modules/gine/dist/gine/math/Math2D.js"}],"../node_modules/gine/dist/index.js":[function(require,module,exports) {
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
...
__export(require("./gine/scene"));
__export(require("./gine/store"));
__export(require("./gine/keyboard.keycodes"));
__export(require("./gine/math"));
//# sourceMappingURL=index.js.map
},{"./gine/config":"../node_modules/gine/dist/gine/config.js","./gine/core":"../node_modules/gine/dist/gine/core.js","./gine/canvas":"../node_modules/gine/dist/gine/canvas.js","./gine/handle":"../node_modules/gine/dist/gine/handle.js","./gine/camera":"../node_modules/gine/dist/gine/camera.js","./gine/image":"../node_modules/gine/dist/gine/image.js","./gine/keyboard":"../node_modules/gine/dist/gine/keyboard.js","./gine/mouse":"../node_modules/gine/dist/gine/mouse.js","./gine/text":"../node_modules/gine/dist/gine/text.js","./gine/tile":"../node_modules/gine/dist/gine/tile.js","./gine/scene":"../node_modules/gine/dist/gine/scene.js","./gine/store":"../node_modules/gine/dist/gine/store.js","./gine/keyboard.keycodes":"../node_modules/gine/dist/gine/keyboard.keycodes.js","./gine/math":"../node_modules/gine/dist/gine/math/index.js"}],"camera.ts":[function(require,module,exports) {
"use strict";
...
var Camera = /** @class */function () {
    ...
    Camera.prototype.adjustPosition = function () {
        var half = gine_1.Gine.CONFIG.width / 2;
        return {
    ...
    Camera.prototype.getBounds = function () {
        var half = gine_1.Gine.CONFIG.width / 2;
        return [{
            x: this.position.x - half - gine_1.Gine.CONFIG.tileSize,
            y: this.position.y - half - gine_1.Gine.CONFIG.tileSize
        }, {
            x: this.position.x + half + gine_1.Gine.CONFIG.tileSize,
            y: this.position.y + half + gine_1.Gine.CONFIG.tileSize
        }];
    };
    Camera.prototype.debugDraw = function () {
        gine_1.Gine.handle.handle.strokeRect(this.position.x - gine_1.Gine.CONFIG.width / 2, this.position.y - gine_1.Gine.CONFIG.height / 2, gine_1.Gine.CONFIG.width, gine_1.Gine.CONFIG.height);
    };
    return Camera;
}();
exports.Camera = Camera;
},{"gine":"../node_modules/gine/dist/index.js"}],"entity.ts":[function(require,module,exports) {
"use strict";
...
var Entity = /** @class */function () {
    ...
    Entity.prototype.draw = function (cameraPos) {
        gine_1.Math2D.rotate(this.img, this.pos.x - cameraPos.x, this.pos.y - cameraPos.y, this.direction);
    };
    Entity.prototype.update = function () {};
    Entity.prototype.die = function () {};
    Entity.getInRange = function (x, y, range) {
        if (range === void 0) {
            range = 1;
        }
        return Entity.entities.filter(function (e) {
            return e.pos.x <= x + range && e.pos.x >= x - range && e.pos.y <= y + range && e.pos.y >= y - range;
        });
    };
    Entity.getInCircle = function (x, y, radius) {
        if (radius === void 0) {
            radius = 1;
        }
        var r2 = radius * radius;
        return Entity.entities.filter(function (e) {
            return (e.pos.x - x) * (e.pos.x - x) + (e.pos.y - y) * (e.pos.y - y) <= r2;
        });
    };
    Entity.delete = function (e) {
        console.log(e);
        var idx = Entity.entities.findIndex(function (et) {
            return et.id === e.id;
        });
        if (idx > -1) {
...
},{"gine":"../node_modules/gine/dist/index.js"}],"entities/core.ts":[function(require,module,exports) {
"use strict";
...
var Core = /** @class */function (_super) {
    ...
    Core.prototype.damage = function () {
        this.health -= 1;
        if (this.health <= 0) {
            this.die();
        }
    ...
    Core.prototype.die = function () {
        entity_1.Entity.delete(this);
    };
    return Core;
}(entity_1.Entity);
exports.Core = Core;
},{"../entity":"entity.ts"}],"entities/enemy.ts":[function(require,module,exports) {
"use strict";
...
var Enemy = /** @class */function (_super) {
    ...
    Enemy.IsEnemy = function (e) {
        return e && !!e.type && e.type === 'enemy';
    };
    return Enemy;
}(entity_1.Entity);
exports.Enemy = Enemy;
},{"../entity":"entity.ts"}],"entities/tower.ts":[function(require,module,exports) {
"use strict";
...
var Tower = /** @class */function (_super) {
    ...
    Tower.prototype.fireOnTarget = function (target) {
    ...
    Tower.prototype.lookForTarget = function () {
        this.target = entity_1.Entity.getInCircle(this.pos.x, this.pos.y, this.range).filter(enemy_1.Enemy.IsEnemy)[0];
    };
    Tower.IsTower = function (e) {
        return e && !!e.type && e.type === 'tower';
    };
    return Tower;
}(entity_1.Entity);
exports.Tower = Tower;
},{"../entity":"entity.ts","./enemy":"entities/enemy.ts"}],"map.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var gine_1 = require("gine");
var GameMap = /** @class */function () {
    function GameMap(widthX, widthY) {
        this.debug = false;
        this.bg = gine_1.Gine.store.get('background');
        this.mapArray = [];
        this.width = widthX;
        // Assuming a square for the map.
        var tiles = widthX * widthY;
        this.mapArray = Array(tiles).fill(0, 0, tiles);
        this.mapArray.map(function (a) {
            return 0;
        });
    }
    GameMap.prototype.getCenter = function () {
        var halfH = Math.round(this.width / 2);
        return { x: halfH * gine_1.Gine.CONFIG.tileSize, y: halfH * gine_1.Gine.CONFIG.tileSize };
    };
    GameMap.prototype.getIndex = function (x, y) {
        return x + this.width * y;
    };
    GameMap.prototype.indexToXY = function (index) {
        return {
            x: Math.floor(index % this.width) * gine_1.Gine.CONFIG.tileSize,
            y: Math.floor(index / this.width) * gine_1.Gine.CONFIG.tileSize
        };
    };
    GameMap.prototype.draw = function (cameraPos) {
        var _this = this;
        if (cameraPos === void 0) {
            cameraPos = { x: 0, y: 0 };
        }
        this.mapArray.forEach(function (v, i) {
            var pos = _this.indexToXY(i);
            gine_1.Gine.handle.draw(_this.bg, pos.x - cameraPos.x, pos.y - cameraPos.y);
            if (_this.debug) {
                gine_1.Gine.handle.setColor(255, 255, 255);
                gine_1.Gine.handle.text(i, pos.x + 16 - cameraPos.x, pos.y + 16 - cameraPos.y);
                gine_1.Gine.handle.resetColor();
            }
        });
    };
    return GameMap;
...
var core_1 = require("../entities/core");
var enemy_1 = require("../entities/enemy");
var tower_1 = require("../entities/tower");
var entity_1 = require("../entity");
...
var MainScene = /** @class */function (_super) {
    ...
    function MainScene() {
        var _this = _super.call(this) || this;
        _this.bg = gine_1.Gine.store.get('background');
        _this.placeholder = gine_1.Gine.store.get('placeholder');
        _this.spider = gine_1.Gine.store.get('spider');
        _this.map = new map_1.GameMap(32, 32);
        _this.camera = new camera_1.Camera();
        _this.core = new core_1.Core(_this.placeholder);
    ...
    MainScene.prototype.init = function () {
        ...
        var half = this.map.width / 2;
        this.core.pos = {
            x: half * gine_1.Gine.CONFIG.tileSize,
            y: half * gine_1.Gine.CONFIG.tileSize
        };
        entity_1.Entity.entities.push(this.core);
        var spider = new enemy_1.Enemy(this.spider, this.core.pos);
        spider.direction = 180;
        spider.pos = {
            x: half * gine_1.Gine.CONFIG.tileSize,
            y: 0
        };
        entity_1.Entity.entities.push(spider);
        var tower = new tower_1.Tower(this.placeholder);
        tower.pos = { x: 440, y: 440 };
        entity_1.Entity.entities.push(tower);
    };
    MainScene.prototype.tick = function () {
        ...
        //     RIGHT_ARROW: number;
        //     DOWN_ARROW: number;
        if (gine_1.Gine.keyboard) {
            var x = 0;
            var y = 0;
            if (gine_1.Gine.keyboard.isPressed(gine_1.KEYCODES.LEFT_ARROW)) {
                x -= 1;
            }
            if (gine_1.Gine.keyboard.isPressed(gine_1.KEYCODES.RIGHT_ARROW)) {
                x += 1;
            }
            if (gine_1.Gine.keyboard.isPressed(gine_1.KEYCODES.UP_ARROW)) {
                y -= 1;
            }
            if (gine_1.Gine.keyboard.isPressed(gine_1.KEYCODES.DOWN_ARROW)) {
                y += 1;
            }
            this.camera.move(x, y);
        }
        entity_1.Entity.entities.forEach(function (e) {
            return e.update();
        });
        entity_1.Entity.getInRange(this.core.pos.x, this.core.pos.y, 12).filter(enemy_1.Enemy.IsEnemy).map(function (e) {
            e.die();
            _this.core.damage();
        });
    };
    MainScene.prototype.frame = function () {
        ...
        entity_1.Entity.entities.forEach(function (e) {
            e.draw(_this.camera.adjustPosition());
        });
        if (this.core.health <= 0) {
            gine_1.Gine.handle.text('You have lost!', gine_1.Gine.CONFIG.width / 2, gine_1.Gine.CONFIG.height / 2);
        }
    };
    return MainScene;
}(gine_1.Scene);
exports.MainScene = MainScene;
},{"gine":"../node_modules/gine/dist/index.js","../camera":"camera.ts","../entities/core":"entities/core.ts","../entities/enemy":"entities/enemy.ts","../entities/tower":"entities/tower.ts","../entity":"entity.ts","../map":"map.ts"}],"main.ts":[function(require,module,exports) {
"use strict";
...
var cfg = new gine_1.Config(document.querySelector('#game'), Object.assign(gine_1.DEFAULT_CONFIG, {
    tileSize: 32,
    width: 600,
    height: 400,
    tickRate: 120,
...
var assets = [{ name: 'placeholder', src: 'placeholder.png' }, { name: 'background', src: 'background.png' }, { name: 'spider', src: 'spider.png' }];
...
},{"gine":"../node_modules/gine/dist/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./scenes/main":"scenes/main.ts"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/main.01d8fab4.map